...
<div class="cart-area pt-20 pb-80">
    <div class="container">
        <div class="row">
        <?php
            
            $select_querry="SELECT product.*, productbrand.productbrand_name
            FROM product
            INNER JOIN productbrand ON productbrand.id = product.product_brand_id
            ...
            if($read){
                while($result_product=$read->fetch_assoc()){
            ...
            <div class="col-xxl-3 pr-xxl-0">
                <div class="cart-img">
                    ...
                    <!-- <div class="cart-multiple-img d-flex justify-content-space-between align-item-center">
                        <a href=""><</a>
                        <img src="assets/img/cart_c/product8.webp" alt="">
                        <img src="assets/img/cart_c/product8.webp" alt="">
                        <img src="assets/img/cart_c/product8.webp" alt="">
                        <a href="">></a>
                    </div> -->
            ...
            <div class="col-xxl-6 pl-xxl-0 pr-xxl-0">
                ...
                <div class="product-name">
                    ...
                    <div class="cart-header d-flex justify-content-space-between">
                        <div class="cart-header-part1">
                        <span>
                            <ul>
                    ...
                    <div class="product-brand">
                        <span>Brand:<a href=""> <?php echo $result_product['productbrand_name']?></a> | <a href="">More Audio From lenevo</a></span>
                    </div>
                    <div class="product-price">
                        <h6>$<?php echo $result_product['current_price']?></h6>
                        <span>$<?php echo $result_product['previous_price']?><h5>-<?php echo $result_product['discount']?>%</h5></span>
                    </div>
                    ...
                    ?>
                        <a href="purchase_cart.php?product_cartid=<?php echo $result_product['id'];?>" class="buy-btn">Buy now</a>
  ...
  <?php }}?>
            ...
            <div class="col-xxl-3  pl-xxl-0">
                <div class="cart-right">
                    <div class="delivery-header d-flex justify-content-space-between align-item-center">
                    <h4>Delivery</h4>
                    <i class="fa-sharp fa-solid fa-circle-info"></i>
                    </div>
                    <div class="cart-location d-flex justify-content-space-between ">
                        <span><i class="fa-solid fa-location-dot"></i> Barishal, Barishal - Agailjhara,<br> Agailjhara Sadar</span>
                        <a href="">Change</a>
                    </div>

                    <div class="cart-delivary d-flex justify-content-space-between p-5">
                        <span><i class="fa-solid fa-truck"></i> Standard Delivery <h6> 2 - 11 day(s)</h6></span>
                        <h5>$12</h5>
                    </div>
                    <div class="cart-cash p-5">
                        <span><i class="fa-solid fa-money-bill"></i> Cash on delivery</span>
                    </div>
                    <div class="delivery-header-bottom d-flex justify-content-space-between align-item-center">
                        <h4>Service</h4>
                        <i class="fa-sharp fa-solid fa-circle-info"></i>
                        </div>
                        <div class="return-policey">
                        ...
                        <div class="agent-name">
                            <table>
                                ...
                                <tr>
                                    <td class="company-name">Navia.Ltd</td>
                                </tr>
                              </table> 
                        </div>
                        <div class="agent-rating text-align-center">
                            <table>
                                <tr>
        ...
        <!-- <div class="row">
            <div class="col-xxl-10 pt-xxl-0 pr-xxl-0">
                <div class="specification">
                    <h4 class="product-header">Product details of Lenovo HE05 Bluetooth Wireless Headphones</h4>
                    <div class="product-specification">
                      <div class="row">
                        <div class="col-xxl-6">
                       <div class="product-details pl-15">
                        <ul>
                            <li>
                                Brand: Lenovo
                            </li>
                        ...
                        <div class="col-xxl-6">
                            <div class="product-details pl-15 pr-15">
                                <ul>
                                    <li>
                ...
                <div class="row">
                    <div class="col-xxl-12 pt-xxl-0">
                        <div class="cart-product">
                            ...
                            <h5>Best Deals</h5>
                            <a href=""><img src="assets/img/product_cart_item/product2.webp" alt=""></a>
                            <h4>Bmw seat A402</h4>
                            <span>$34<p> -54%</p></span>
                            <ul>
                                <li><i class="fa-solid fa-star"></i></li>
                ...
                <div class="row">
                    <div class="col-xxl-12 pt-xxl-0">
                        <div class="cart-product">
                            ...
                            <h5>Best Deals</h5>
                            <a href=""><img src="assets/img/product_cart_item/product6.webp" alt=""></a>
                            <h4>Bmw seat A402</h4>
                            <span>$34<p> -54%</p></span>
                            <ul>
                                <li><i class="fa-solid fa-star"></i></li>
