...
<!-- get method  -->
            ...
            <?php
            if(isset($_GET['sellcarby_brand_id'])){
                $sellcarby_brand_id=$_GET['sellcarby_brand_id'];
            }
            ?>
        ...
        <div class="row">
            ...
            <div class="col-xxl-9 col-sm-12 col-md-12 col-lg-9 col-xl-9 p-xl-0 pt-xl-15">
                <div class="car-type d-flex justify-content-space-between">
                        ...
                        <?php
                            $select_brand="SELECT * FROM carbrand ORDER BY  rand() LIMIT 7";
                    ...
                    <div class="single-type">
                        <a href="sellcarby_brand.php?sellcarby_brand_id=<?php echo $result_brand['id']?>"> </a>
                        <img src="admin/<?php echo $result_brand['brandimage'] ?>" alt="" class="brand-img">
                    </div>
        ...
        <div class="row">
            ...
            <!-- php code start  -->
                    <?php 
                        ...
                        where sellcar.carbrand_id='$sellcarby_brand_id'
                        ORDER BY sellcar.id asc
                        LIMIT 10";
