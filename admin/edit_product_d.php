                ...
                <!-- php code end  -->
                 ...
                 <form action="" method="post"  enctype="multipart/form-data">
                    ...
                    <?php 
                          ...
                          $select_product="SELECT product.*,productbrand.*
                          from  product
                          INNER join productbrand on
                          productbrand.id=product.product_brand_id 
                          where product.id='$editproductid'
                          order by product.product_name";

                          $read=$db->select($select_product);
                          if($read){
                    ...
                    <option value="<?php echo $result['product_brand_id']?>"><?php echo $result['productbrand_name'];?></option>

                        <?php 
                        $select_brand="select * from  productbrand";
                        $read_brand=$db->select($select_brand);
                        if($read_brand){
                            while($result_brand=$read_brand->fetch_assoc()){
                        
                        ?>



                    <option value="<?php echo $result_brand['id']?>"><?php echo $result_brand['productbrand_name'];?></option>    
                    ...
                    <?php }}?>
                        ...
                        <tr>
                            <td>
                            Discount Percentage: <input type="text" name="discount" value="<?php echo $result['current_price']."%";?>" placeholder="Enter title." class="medium" />
                            </td>
                        </tr>
						<tr> 
                            <td>
