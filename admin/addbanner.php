...
<?php include 'lib/database.php' ;?>
       ...
       <?php
         ...
         if(isset($_POST['submit'])){
            $bannar_header=$_POST['bannar_header'];
            $bannar_title=$_POST['bannar_title'];
            ...
            if(empty($bannar_image)){
                ...
                $insert="insert into  bannar(bannar_image,bannar_header,bannar_title) values('$main_bannar_image','$bannar_header','$bannar_title')";
                $insert_banner=$db->insert($insert);
                if($insert_banner){
                    echo "insert success";
                }else{
       ...
       ?>
                 ...
                 <form action="" method="post" enctype="multipart/form-data">
                    <table class="form">					
                        <tr>
                            <td>
                               Title: <input type="file" name="banner"  class="medium" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                               Title: <input type="text" name="bannar_header"  class="medium" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                               Title: <input type="text" name="bannar_title"  class="medium" />
                            </td>
                        </tr>
